...
DUDAS: unidades de M en el 2 son metros? La conclusion entrre E y S?
\end{center}
\vspace{8cm}
...
\item Completar una tabla con los valores de $R$ y $D$ si los datos de entrada de $E$ se multiplican por: 0.5, 0.75, 1 (que fueron obtenidos),1.25 y 1.5.\\
 ...
 Los valores de $h(t)$ obtenidos son:\\
\begin{center}
\begin{tabular}{|c|c|c|}
\hline
$k$ & $t_k$ & $h(t_k)$ \\ \hline
...
\label{fig:item3}
\end{figure}
El efecto que produce el embalse atenuando y retardando el fen\'omeno de credida es.....\\
...
\end{array}
 ...
 \subsection{item 4}
 Multiplicando $E(t)$ por los siguientes factores, los resultados de la relaci\'on $R$ entre los picos de $E(t)$ y $S(t)$ y la distancia $D$ corresponden a la siguiente tabla:\\
\begin{center}
 \begin{tabular}{|c|c|c|}
 \hline
 Factor & $R$ & $D [m]$ \\\hline
...
%
% Interpola por spline utilizando el método
%  interp1 sugerido
%
...
%
% Evalua la función E de entrada de agua 
% al embalse
%
...
%
% Evalua la función A de sección horizontal 
% del embalse
%
...
%
% Evalua la función S de salida de agua del embalse
%
...
%
% Función f(t_k, y_k) utilizada por el método de 
% Runge-Kutta para aproximar h(t). 
% Equivale a la función h'(t) del enunciado.
%
